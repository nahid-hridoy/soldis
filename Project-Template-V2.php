...
/*
Template Name: Project Template V2
 */
...
?>
    ...
    <div class="container-fluid p-t-0-b-30">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 custom-col-padding-1">
                <div class="project-breadcumb">
                    <ul>
                        ...
                        <li class="active"><a href="projects">Объекты</a></li>
                    </ul>
                </div>
            ...
            <div class="col-md-12 custom-width-for-hd">
...
?>
                ...
                <div class="project-filter-list-dropdown text-center update1 single-filter-dropdown" id="dd" tabindex="1">
                    <span class="single-filter-dropdown">ВСЕ ОБЪЕКТЫ</span>
